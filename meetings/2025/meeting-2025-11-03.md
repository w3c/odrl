...
Victor, Andrea: The document is very sketchy, but potentially general interest on this profile --and the current spec is probably compatible with the Data Spaces needs. 
...
Nicoletta: A meeting happened where the following was agreed: the state of the world needs an id. There is static and dynamic information. Examples need to be updated. The ontologies started by Andrea and Beatriz need to be updated too (state of the world and evaluation result). 
...
Rigo: Decoupling evaluation and semantics is critical and good.
